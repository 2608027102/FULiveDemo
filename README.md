...
注：第一运行Demo会报缺少证书的 error ,如果您已拥有我司颁发的证书，将证书替换到工程中重新运行即可。如您还没有我司颁发的证书，可以查看[这里](https://github.com/Faceunity/FULiveDemo/tree/beta#%E5%AF%BC%E5%85%A5%E8%AF%81%E4%B9%A6)获取证书
...
### 一、OC层API参考文档
 ...
 [Nama API OC Reference](https://github.com/Faceunity/FULiveDemo/blob/beta/docs/%20Nama%20API%20OC%20Reference.md)

### 二、C层API参考文档

 [Nama API reference](https://github.com/Faceunity/FULiveDemo/blob/beta/docs/Nama%20API%20reference.pdf)
